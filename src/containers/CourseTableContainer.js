                    ...
                    <table id="courses" className="table table-hover" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th className="priority-1" scope="col" width="3%"><i className="fa fa-th-large" aria-hidden="true"></i></th>
                                <th className="priority-1" scope="col" width="3%"><i className="fa fa-arrow-up" aria-hidden="true"></i></th>
